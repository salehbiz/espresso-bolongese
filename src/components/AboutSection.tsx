...
export default function AboutSection() {
  return (
    <section id="about" className="section pt-28 sm:pt-32 pb-0 bg-[#3E3226] text-white">
      ...
      <div className="container max-w-[1440px] mx-auto px-5 sm:px-8 mb-16 sm:mb-20 text-center">
        <div className="flex flex-col items-center justify-start gap-8 max-w-[700px] mx-auto">
          {/* Wave SVG Icon */}
          <div className="svg-icon text-[#FAF7F2]">
            <WaveDivider />
          </div>
          ...
          <div className="home-about-heading-div max-w-[400px] mx-auto">
            <h2 className="text-white">
              ...
              <em className="text-[#FAF7F2] font-normal italic">crafted for you</em>
            </h2>
          </div>

          {/* 2 Paragraphs */}
          <div className="space-y-4 max-w-[560px] mx-auto">
            <p className="large-paragraph home-about-paragraph text-[#FAF7F2]/90">
      ...
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-0 w-full">
          ...
          <div className="md:col-span-3 img-zoom-container h-[300px] sm:h-[380px] lg:h-[400px] w-full bg-[#FAF7F2]/20">
            <img
          ...
          <div className="md:col-span-2 img-zoom-container h-[260px] sm:h-[340px] lg:h-[400px] w-full bg-[#FAF7F2]/20">
            <img
