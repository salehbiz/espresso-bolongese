...
export default function OurStorySection() {
  return (
    <section className="relative bg-[#FAF7F2] text-[#3E3226] overflow-hidden py-24 sm:py-32 border-t border-[#E5DCCE]">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(106deg, #FAF7F2 40%, rgba(250, 247, 242, 0.95) 48%, rgba(250, 247, 242, 0) 65%), url("https://cdn.prod.website-files.com/68f0d3dd9d3c1fec17146b9f/69021780d95d14f02682f330_our-story-background.webp")`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 max-w-[580px] flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6 pt-4">
              <p className="font-heading text-xl sm:text-2xl text-[#8C7355] font-medium leading-relaxed italic">
