...
export default function OurStorySection() {
  return (
    <section className="relative bg-[#f2efe2] overflow-hidden py-24 sm:py-32 border-t border-[#e4dcc4]">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(106deg, #f2efe2 40%, rgba(242, 239, 226, 0.95) 48%, rgba(242, 239, 226, 0) 65%), url("https://cdn.prod.website-files.com/68f0d3dd9d3c1fec17146b9f/69021780d95d14f02682f330_our-story-background.webp")`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 max-w-[580px] flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6 pt-4">
              <p className="font-urbanist text-xl sm:text-2xl text-[#8B6843] font-medium leading-relaxed italic">
              ...
              <div className="flex items-center gap-3.5">
                <img
                  ...
                  alt="James Thompson"
                  className="w-11 h-11 rounded-full object-cover border border-[#cdbba2]"
                />
                <div className="text-xs sm:text-sm text-[#6D6D6D] font-medium leading-tight">
                  <div className="font-semibold text-[#3D3D3D]">James Thompson</div>
