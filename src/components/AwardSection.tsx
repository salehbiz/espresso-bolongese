...
export default function AwardSection({ variant = "white" }: AwardSectionProps) {
  ...
  return (
    <section className={`py-20 sm:py-28 ${bgClass} border-t border-[#f2efe2]`}>
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left">
          {/* Left Text */}
          <div className="max-w-[560px]">
            <h2 className="text-[#3D3D3D] text-3xl sm:text-4xl md:text-[46px] mb-3">
              An Award-winning escape
            </h2>
            <p className="large-paragraph award-paragraph text-[#6D6D6D]">
