...
export default function RewardsSection() {
  ...
  return (
    <section className="py-24 sm:py-32 bg-[#FAF7F2] text-[#3E3226]">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8">
        {/* Section Heading */}
        <div className="max-w-[650px] mx-auto text-center mb-16 sm:mb-20">
          <h2 className="text-[#3E3226] mb-4">
            Asatha <em className="text-[#8C7355] font-normal italic">Rewards</em>
          </h2>
          <p className="large-paragraph reward-paragraph text-center text-[#7A6F64]">
