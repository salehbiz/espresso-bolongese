      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start mb-16 sm:mb-20">
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-8 pt-2">
            {/* Contact */}
            <div>
              <h3 className="font-urbanist text-xs font-bold uppercase tracking-widest text-[#8C7355] mb-3">
                Contact
              </h3>
              <div className="space-y-1 text-sm font-urbanist text-[#3E3226]">
                <div>
                  P: <span className="font-medium text-[#8C7355]">+62 812 3456 7890</span>
                </div>
                <div>
                  E: <span className="font-medium text-[#8C7355]">stay@asatha.com</span>
                </div>
                <div>
                  Reception: <span className="font-medium text-[#8C7355]">WhatsApp</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="font-urbanist text-sm text-[#3E3226] leading-relaxed">
        ...
        <div className="img-zoom-container relative h-[360px] sm:h-[480px] md:h-[580px] w-full overflow-hidden shadow-xs bg-[#FAF7F2]">
          <img
